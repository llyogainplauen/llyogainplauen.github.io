...
function t_cover__processHTML5Video(n, o, i) {
    ...
    var e = -1 !== o["cover-height"].indexOf("vh") && 100 < parseInt(o["cover-height"], 10)
        ...
        , c = !1
        , r = (i && (e || t) && (n.style.height = "100vh",
        c = !0),
        !o["video-noloop"])
        , a = !o["video-nomute"];
    "IntersectionObserver"in window ? new IntersectionObserver(function(e, t) {
            e.forEach(function(e) {
                e.isIntersecting && (e = e.target,
                    t.unobserve(e),
                    t_cover__createAndProcessHTML5Video(e, o, r, a))
            })
        }
    ).observe(n) : (t_cover__createHTMLVideoCover(n, o, c, i, r, a),
        window.addEventListener("scroll", t_throttle(function() {
            t_cover__createHTMLVideoCover(n, o, c, i, r, a)
        }, 100))),
        window.addEventListener("scroll", function() {
            var e, t, o, r;
            i && c && (r = n.parentElement,
                t = (e = window.pageYOffset) + window.innerHeight,
                o = t_cover__getPureHeight(r),
                (r = r.getBoundingClientRect().top + e) + o <= t ? (n.style.position = "absolute",
                    n.style.bottom = "0px",
                    n.style.top = "auto") : r <= e ? (n.style.position = "fixed",
                    n.style.top = "0px") : e < r && (n.style.position = "relative",
                    n.style.top = "auto"))
        })
}
function t_cover__setStylesForCoverVideo(e, t) {
    e.style.backgroundColor = "#000000",
        e.style.backgroundImage = "youtube" === t ? "" : 'url("https://google.ws/img/spinner-white.gif")',
...
function t_cover__initCovers() {
    ...
    !!e && "edit" === e.getAttribute("data-mode") || (e = document.querySelectorAll(".t-cover__carrier"),
...
function t_cover__createYoutubeCover(e, t) {
    var o, r, n, i;
    e.querySelector("iframe") || (o = window.pageYOffset,
        r = window.innerHeight,
        n = t_cover__getPureHeight(e),
    (i = e.getBoundingClientRect().top + o) - 500 < o + r && o <= i + n + 500 && t_onFuncLoad("processYoutubeVideo", function() {
        window.processYoutubeVideo(e, t)
    }))
}
function t_cover__createHTMLVideoCover(e, t, o, r, n, i) {
    var c, a, d, l;
    e.querySelector("video") || (c = window.pageYOffset,
        a = window.innerHeight,
        d = t_cover__getPureHeight(e),
    (l = e.getBoundingClientRect().top + c) - 500 < c + a && c <= d + l + 500 && t_cover__createAndProcessHTML5Video(e, t, n, i))
}
...
function t_cover__updateResizeElem(e) {
    ...
    !o || "yes" !== o.getAttribute("data-lazy") || (t = e.querySelector(".t-cover__carrier"),
